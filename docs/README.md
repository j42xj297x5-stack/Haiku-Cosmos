...
2. `docs/legacy/` czytaj tylko na wyraźne polecenie (kontekst historyczny).
3. Po większych zmianach aktualizuj mapy README (`README.md`, `docs/README.md`, `docs/current/README.md`).
