> Status: KANON
> Obszar: SUB META / konfiguracja gałęzi PRG i ŚWIAT
> Źródło prawdy: TAK
> Ostatnia aktualizacja: 2026-04-24
> Powiązane dokumenty: ../maps/PROJECT_INDEX.md, CARDS_SYSTEM.md, ECONOMY_SYSTEM.md, ../ui/UI_WORLD.md, PRG_SYSTEM.md
