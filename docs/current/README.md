...
- `systems/DUST_COLLECTION_AND_REFINEMENT_SYSTEM.md` - **ROBOCZY / KANDYDAT DO KANONU / PRZED RUNTIME** - pętla meteor → pył → HUD stosik → depozyt → Magazyn → Kuźnia → flakon/naczynie → kryształ → stabilizator slotu; doprecyzowuje, że HUD zbiera tylko surowy pył do stosiku.
...
- `ui/DUST_STACK_HUD_VISUAL_CHECKLIST.md` - **ROBOCZY / CHECKLISTA UI-VISUAL / HUD PYŁU** - checklista ikony stosiku pyłu, maski `0–100%`, koloru, stanu `80%`, `100%` i depozytu przed assetami i runtime.
