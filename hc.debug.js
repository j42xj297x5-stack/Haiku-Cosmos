    ...
    return {
      ...
      visual: {
        ...
        threeLights: {
          ...
          debugSpotLightEnabled: lightsCfg.debugSpotLightEnabled === true,
          debugSpotLightIntensity: Number.isFinite(Number(lightsCfg.debugSpotLightIntensity)) ? Math.max(0, Math.min(25.0, Number(lightsCfg.debugSpotLightIntensity))) : 12,
          debugSpotLightAngle: Number.isFinite(Number(lightsCfg.debugSpotLightAngle)) ? Math.max(Math.PI / 24, Math.min(Math.PI / 2, Number(lightsCfg.debugSpotLightAngle))) : Math.PI / 5,
          debugSpotLightPenumbra: Number.isFinite(Number(lightsCfg.debugSpotLightPenumbra)) ? Math.max(0, Math.min(1, Number(lightsCfg.debugSpotLightPenumbra))) : 0.35,
          debugSpotLightDistance: Number.isFinite(Number(lightsCfg.debugSpotLightDistance)) ? Math.max(0, Math.min(100000, Number(lightsCfg.debugSpotLightDistance))) : 0,
          debugSpotLightDecay: Number.isFinite(Number(lightsCfg.debugSpotLightDecay)) ? Math.max(0, Math.min(3, Number(lightsCfg.debugSpotLightDecay))) : 1,
          debugSpotLightTargetMode: ["center", "sampleObject"].includes(String(lightsCfg.debugSpotLightTargetMode)) ? String(lightsCfg.debugSpotLightTargetMode) : "center",
  ...
  function buildThreeRendererEvidenceVisual() {
    ...
    return {
      ...
      threeLights: {
        ...
        debugSpotLightEnabled: lights.debugSpotLightEnabled === true,
        debugSpotLightIntensity: pickThreeLightSetting(lights, "debugSpotLightIntensity"),
        debugSpotLightAngle: pickThreeLightSetting(lights, "debugSpotLightAngle"),
        debugSpotLightPenumbra: pickThreeLightSetting(lights, "debugSpotLightPenumbra"),
        debugSpotLightDistance: pickThreeLightSetting(lights, "debugSpotLightDistance"),
        debugSpotLightDecay: pickThreeLightSetting(lights, "debugSpotLightDecay"),
        debugSpotLightTargetMode: pickThreeLightSetting(lights, "debugSpotLightTargetMode", "center"),
      ...
      debugSpotLight: {
        enabled: lights.debugSpotLightEnabled === true,
        intensity: pickThreeLightSetting(lights, "debugSpotLightIntensity"),
        angle: pickThreeLightSetting(lights, "debugSpotLightAngle"),
        penumbra: pickThreeLightSetting(lights, "debugSpotLightPenumbra"),
        distance: pickThreeLightSetting(lights, "debugSpotLightDistance"),
        decay: pickThreeLightSetting(lights, "debugSpotLightDecay"),
        targetMode: pickThreeLightSetting(lights, "debugSpotLightTargetMode", "center"),
        position: diagnostics?.debugSpotLight?.position || lightDiagnostics?.debugSpotLight?.position || null,
        targetPosition: diagnostics?.debugSpotLight?.targetPosition || lightDiagnostics?.debugSpotLight?.targetPosition || null,
        helperVisible: diagnostics?.debugSpotLight?.helperVisible === true || lightDiagnostics?.debugSpotLightHelperVisible === true,
        targetInScene: diagnostics?.debugSpotLight?.targetInScene === true,
        castShadow: diagnostics?.debugSpotLight?.castShadow === true,
      ...
      lights: {
        ...
        debugSpotLightTargetMode: lightDiagnostics?.debugSpotLightTargetMode || lights.debugSpotLightTargetMode || "center",
        debugSpotLightHelperVisible: lightDiagnostics?.debugSpotLightHelperVisible === true || diagnostics?.debugSpotLight?.helperVisible === true,
        sampleObjectProjected: lightDiagnostics?.sampleObjectProjected || diagnostics?.firstMeteorScreenEstimate || null,
        sampleObjectFrustumVisible: lightDiagnostics?.sampleObjectFrustumVisible ?? diagnostics?.firstMeteorInCameraBounds ?? null,
