...
(function () {
  ...
  function mapBody(body, fallbackKind, index) {
    ...
    return {
      ...
      visualVariant: body.visualVariant || body.modelId || body.glbId || (isPlanet ? (planetKind === "rocky" ? ROCKY_PLANET_BASE_VISUAL.visualVariant : PLANET_BASE_VISUAL.visualVariant) : null),
      modelId: body.modelId || body.glbId || body.visualVariant || null,
      glbId: body.glbId || body.modelId || body.visualVariant || null,
