...
(() => {
  ...
  const World = {
    ...
    spaceMechanics: {
      ...
      prgIndicatorDashCount: 48,
      prgIndicatorOpacity: 0.45,
      prgIndicatorLineWidth: 1,
...
meteorBaseScale: METEOR_BASE_SCALE,
  ...
  function resetWorld() {
    ...
    World.spaceMechanics = Object.assign({}, World.spaceMechanics, {
      ...
      harmonicDustAsteroidGrayRate: Number(World.spaceMechanics?.harmonicDustAsteroidGrayRate) || 0.35,
      harmonicDustAsteroidMinOverlapRatio: Number(World.spaceMechanics?.harmonicDustAsteroidMinOverlapRatio) || 0.15,
      harmonicDustElasticGrayEnabled: World.spaceMechanics?.harmonicDustElasticGrayEnabled !== false,
      harmonicDustGrayConversionThreshold: Number(World.spaceMechanics?.harmonicDustGrayConversionThreshold) || 1.0,
      harmonicDustGrayRecoveryTimeMul: Number(World.spaceMechanics?.harmonicDustGrayRecoveryTimeMul) || 2.0,
      harmonicDustGrayMinRecoverableRatio: Number(World.spaceMechanics?.harmonicDustGrayMinRecoverableRatio) || 0.0,
      harmonicDustGrayLockAtThreshold: World.spaceMechanics?.harmonicDustGrayLockAtThreshold !== false,
      harmonicDustGrayBaseRate: Number(World.spaceMechanics?.harmonicDustGrayBaseRate) || 0.25,
      harmonicDustGrayDensityMul: Number(World.spaceMechanics?.harmonicDustGrayDensityMul) || 1.0,
      harmonicDustGraySpeedMul: Number(World.spaceMechanics?.harmonicDustGraySpeedMul) || 1.0,
      harmonicDustGrayOverlapMul: Number(World.spaceMechanics?.harmonicDustGrayOverlapMul) || 1.0,
      harmonicDustMoonRingAbsorbEnabled: World.spaceMechanics?.harmonicDustMoonRingAbsorbEnabled !== false,
      harmonicDustMoonRingAbsorbRate: Number(World.spaceMechanics?.harmonicDustMoonRingAbsorbRate) || 0.30,
      harmonicDustMoonRingMinOverlapRatio: Number(World.spaceMechanics?.harmonicDustMoonRingMinOverlapRatio) || 0.15,
      harmonicDustMoonRingMaxCount: Number(World.spaceMechanics?.harmonicDustMoonRingMaxCount) || 4,
      prgIndicatorEnabled: World.spaceMechanics?.prgIndicatorEnabled !== false,
      prgIndicatorDashCount: Number(World.spaceMechanics?.prgIndicatorDashCount) || 48,
      prgIndicatorOpacity: Number(World.spaceMechanics?.prgIndicatorOpacity) || 0.45,
      prgIndicatorLineWidth: Number(World.spaceMechanics?.prgIndicatorLineWidth) || 1,
