...
(function (root) {
  ...
  const DEFAULT_ELEMENTS = Object.freeze([
    ...
    element("prg-intencja-label", "submeta_prg-intencja.png", 0.2, 0.24, 1.2, 1.2, 25),
    element("prg-intencja-logo", "submeta_prg-intencja-logo.png", 0.12, 0.24, 1.3, 1.3, 25),
    element("prg-czas-label", "submeta_prg-czas.png", 0.195, 0.315, 1.2, 1.2, 25),
    element("prg-czas-logo", "submeta_prg-czas-logo.png", 0.12, 0.315, 1.3, 1.3, 25),
    element("prg-cisza-label", "submeta_prg-cisza.png", 0.192, 0.386, 1.2, 1.2, 25),
    ...
    element("r2", "submeta_r2.png", 0.24, 0.12, 0.8, 0.8, 1),
    element("r4", "submeta_R4.png", 0.5, 0.5, 0.7, 0.7, 22),
    element("r3", "submeta_r3.png", 0.475, 0.25, 1, 1, 14),
    element("inventory-panel", "submeta_magazyn-panel.png", 0.73, 0.235, 0.92, 0.92, 10),
    element("inventory-label", "submeta_magazyn.png", 0.73, 0.113, 1, 1, 25),
    ...
    element("card-description-panel", "submeta-opis_karty-panel.png", 0.739, 0.795, 1.06, 1, 10),
