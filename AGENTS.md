...
- Przed użyciem Figma przeczytaj `docs/current/visual/FIGMA_WORKFLOW.md`.
- Przy zadaniach SUB-META przeczytaj także pakiet `docs/current/visual/SUB_META_*`.
- Domyślnie zaczynaj od asset/component pass, nie od implementacji kodu.
- Figma nie projektuje właściwych rasterów PNG/WebP; rastry powstają poza Figmą.
- `Implement Design` używaj tylko na wyraźne polecenie użytkownika.
