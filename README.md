...
- Pozostałe dokumenty robocze/historyczne do dalszej migracji: katalog [`md/`](md/README.md).
...
- **2026-04-24** — kontrolowana migracja map + systemów gry + UI/I18N do `docs/current/`.
